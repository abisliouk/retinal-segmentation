...
def augment_data(images, masks, save_path, augment=True):
    ...
    for idx, (x, y) in tqdm(enumerate(zip(images, masks)), total=len(images)):
        ...
        for i, m in zip(X, Y):
            ...
            image_path = "D:/ML_Project/Retina-Blood-Vessel-Segmentation-using-UNET-in-TensorFlow-main/new_data/train/image/" + tmp_image_name
...
if __name__ == "__main__":
    ...
    """ Load the data """
    data_path = "D:/ML_Project/Retina-Blood-Vessel-Segmentation-using-UNET-in-TensorFlow-main/"
    ...
    create_dir(os.path.join(data_path, "new_data/train/image"))
    create_dir(os.path.join(data_path, "new_data/train/mask"))
